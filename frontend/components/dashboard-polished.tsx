...
import { setTheme, type Theme } from "@/backend/lib/theme";
...
export default function DashboardPolished() {
  ...
  const workspaceSkeletons = Array.from({length : 6}, (_, index) => index);
  const showWorkspaceSkeletons = isLoading && !error && workspaces.length === 0;
    ...
    <>
              ...
              <div className={`view-panel ${view === "dashboard" ? "active" : ""}`}>
                ...
                <div className="ws-frame">
                  <div className="workspace-grid">
                    {showWorkspaceSkeletons
                      ? workspaceSkeletons.map((item) => (
                          <div className="ws-card ws-skeleton" key={`workspace-skeleton-${item}`}>
                            <div className="ws-skeleton-top" />
                            <div className="ws-skeleton-lines">
                              <span />
                              <span />
                            </div>
                            <div className="ws-skeleton-dot" />
                          </div>
                        ))
      ...
      <style jsx>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .ws-skeleton-lines span {
          height: 8px;
          border-radius: 999px;
          background: var(--border2);
        }

        .ws-skeleton-lines span:last-child {
          width: 65%;
        }
